...
output_file = "output/hi-bowl/test_debug.xlsx"

wb = openpyxl.load_workbook(output_file, data_only=True)
ws = wb['海外新业态管报收入数据-本位币']

# Check time segment revenues
print("Time segment revenues in newly generated file:")
revenues = [
    ("AS8", "08:00-13:59销售收入"),
    ("AT8", "14:00-16:59销售收入"), 
    ("AU8", "17:00-21:59销售收入"),
...
# Also check what should be the overnight value
print("\nExpected overnight segment value: $12,000.36")
print(f"Actual overnight segment value: ${ws['AV8'].value:,.2f}")
print(f"Difference: ${12000.36 - ws['AV8'].value:,.2f}")
