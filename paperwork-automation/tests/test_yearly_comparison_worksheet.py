...
class TestYearlyComparisonWorksheetGenerator(unittest.TestCase):
    ...
    def test_generate_worksheet_with_valid_data(self):
        ...
        ws = self.generator.generate_worksheet(wb, self.sample_yearly_current, self.sample_yearly_previous)
    ...
    def test_data_calculations(self):
        ...
        self.assertEqual(store1_growth_rate, "7.1%")  # (150-140)/140 * 100 ≈ 7.1%
    ...
    def test_worksheet_formatting(self):
        ...
        self.assertIn('FFFF00', growth_rate_cell.fill.start_color.rgb)  # Highlighted
    ...
    def test_negative_percentage_formatting(self):
        ...
        wb = Workbook()
        ws = self.generator.generate_worksheet(wb, negative_data_current, negative_data_previous)
...
class TestYearlyComparisonWorksheetIntegration(unittest.TestCase):
    ...
    def test_realistic_data_volumes(self):
        ...
        wb = Workbook()
        ws = self.generator.generate_worksheet(wb, realistic_current, realistic_previous)
        ...
        expected_total = sum(store['total_tables'] for store in realistic_current)
