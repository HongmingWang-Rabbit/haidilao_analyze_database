...
class TestTimeSegmentWorksheetGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.generator = TimeSegmentWorksheetGenerator(
            self.store_names, self.test_date)
    ...
    def test_calculate_differences(self):
        ...
        target_diff, prev_diff = self.generator.calculate_differences(
    ...
    def test_calculate_store_totals(self):
        ...
        self.assertAlmostEqual(
            totals['total_turnover_current'], expected_total_turnover, places=2)

        expected_total_target = 0.85 + 0.60 + 1.97 + 0.78
        self.assertAlmostEqual(
            totals['total_target'], expected_total_target, places=2)
    ...
    def test_calculate_overall_totals(self):
        ...
        # Verify calculations
        self.assertAlmostEqual(
            totals['overall_turnover_current'], 3.0, places=1)
    ...
    def test_get_time_segment_data_for_date(self):
        ...
        for store_id in range(1, 8):
            ...
            for segment in self.generator.time_segments:
                ...
                required_fields = [
                    'turnover_current', 'turnover_prev', 'target', 'tables', 'customers']
                for field in required_fields:
    ...
    def test_generate_worksheet(self):
        ...
        self.assertIn("门店分时段营业数据", title_cell.value)
    ...
    def test_worksheet_data_structure(self):
        ...
        self.assertGreaterEqual(ws.max_row, expected_min_rows - 5)
        ...
        self.assertTrue(
            store_found, "Store names should be present in the worksheet")
        ...
        self.assertTrue(
            segment_found, "Time segments should be present in the worksheet")
    ...
    def test_merged_cells(self):
        ...
        self.assertIn('A1:O1', merged_ranges)
